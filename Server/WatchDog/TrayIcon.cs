...
namespace WatchDog
{
    namespace TrayIconTest
    {
        internal class TrayIcon : ApplicationContext
        {
            ...
            private readonly ConfigurationSerializer<Configuration> _configurationSerializer;
            ...
            public TrayIcon()
            {
                ...
                _configurationSerializer =
                    new ConfigurationSerializer<Configuration>("configuration.json", _configuration);
            ...
            private void InitializeComponent()
            {
                ...
                {
                    ExceptionsManager.ServerCrash("Exception Watchdog initialization",
                        "Exception during Watchdog initialization :" + ex.Message, true);
                }
            }
            ...
            private void InitializeApplication()
            {
                try
                {
                    ...
                    Directory.CreateDirectory(FileUtils.Combine(
                        Path.GetDirectoryName(new Uri(Assembly.GetExecutingAssembly().CodeBase).LocalPath), "\\logs"));
                ...
                {
                    ExceptionsManager.ServerCrash("Exception during Watchdog initialization",
                        "Exception during Watchdog initialization :" + ex.Message, true);
                }
            }
            ...
            {
                var applicationWatcher = new ApplicationWatcher(_logger);
